...
It is also possible to build using CMake and a CMakeLists.txt file
...
will need libobj and the gnustep-base developer package, both from GNUstep (or another
